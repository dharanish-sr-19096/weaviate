...
import (
	...
	"github.com/weaviate/weaviate/modules/text2vec-morph/clients"
...
func New() *MorphModule {
	return &MorphModule{}
}

type MorphModule struct {
...
func (m *MorphModule) Name() string {
	return Name
}

func (m *MorphModule) Type() modulecapabilities.ModuleType {
	return modulecapabilities.Text2ManyVec
}

func (m *MorphModule) Init(ctx context.Context,
...
func (m *MorphModule) InitExtension(modules []modulecapabilities.Module) error {
...
func (m *MorphModule) initVectorizer(ctx context.Context, timeout time.Duration,
	logger logrus.FieldLogger,
) error {
	morphApiKey := os.Getenv("MORPH_APIKEY")

	client := clients.New(morphApiKey, timeout, logger)
...
func (m *MorphModule) initAdditionalPropertiesProvider() error {
...
func (m *MorphModule) AdditionalProperties() map[string]modulecapabilities.AdditionalProperty {
...
func (m *MorphModule) VectorizableProperties(cfg moduletools.ClassConfig) (bool, []string, error) {
	return true, nil, nil
}
